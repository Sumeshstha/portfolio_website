  ...
  const certificateCategories = {
    ...
    participation: {
      ...
      items: [
        ...
        {
          title: 'Hackathon',
          institution: 'IT meet 2022',
          year: '2022',
          description: 'Active participation in hackathon',
          certificates: [
            { id: 11, title: 'Hackathon Winner', image: hackfestCertificate, description: 'Active participation in hackathon' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-2 px-4 py-2 sm:px-6 sm:py-3 bg-white dark:bg-gray-800 text-light-text dark:text-dark-text rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-light-primary dark:hover:border-dark-primary group"
            aria-label="Navigate back to About section"
            role="button"
            tabIndex={0}
            onKeyDown={(e) => {
          ...
          >
            <FaArrowLeft className="w-4 h-4 sm:w-5 sm:h-5 text-light-primary dark:text-dark-primary group-hover:-translate-x-1 transition-transform duration-300" />
